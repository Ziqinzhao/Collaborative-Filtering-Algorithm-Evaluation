...
gradesc <- function(f = 1, 
                    lambda = .3,lrate = 0.01, max.iter, stopping.deriv = .01,
                    data, train, test){
  set.seed(0)
...
# Default values used- base gradesc f= 10, lambda: .3, lrate: .01, stopping.deriv:.01
# If statement values for RMSE: l %% 10 == 0
